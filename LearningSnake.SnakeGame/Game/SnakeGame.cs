...
namespace LearningSnake.SnakeGame.Game
{
    public class GameOfSnake
    {
        ...
        public GameOfSnake(int boardHeight, int boardWidth, int snakeInitialLength, int randomSeed)
        {
        ...
        {
            return _moves + (Math.Pow(2, _snakeLength) + Math.Pow(_snakeLength, 2.1) * 500) - Math.Pow(_snakeLength, 1.2) * Math.Pow((0.25 * _moves), 1.3);
        }
